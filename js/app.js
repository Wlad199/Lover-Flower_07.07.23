(() => {
    ...
    function setLeftValue() {
        let min = parseInt($("#input-left").attr("min")), max = parseInt($("#input-left").attr("max")), text = Math.min(parseInt($("#input-left").val()), parseInt($("#input-right").val()) - 1), percent = (text - min) / (max - min) * 100;
        $("#input-left").val(text);
    ...
    function setRightValue() {
        let min = parseInt($("#input-right").attr("min")), max = parseInt($("#input-right").attr("max")), text = Math.max(parseInt($("#input-right").val()), parseInt($("#input-left").val()) + 1), percent = (text - min) / (max - min) * 100;
